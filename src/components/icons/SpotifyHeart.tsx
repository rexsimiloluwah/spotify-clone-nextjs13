...
interface SpotifyHeartProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

const SpotifyHeart: React.FC<SpotifyHeartProps> = ({ size, ...props }) => {
  return (
    <svg
      role="img"
      height={size}
...
SpotifyHeart.defaultProps = {
  size: 24,
};

export default SpotifyHeart;
