...
interface SpotifyConnectDeviceProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

const SpotifyConnectDevice: React.FC<SpotifyConnectDeviceProps> = ({
  size,
  ...props
}) => {
  return (
...
SpotifyConnectDevice.defaultProps = {
  size: 24,
};

export default SpotifyConnectDevice;
