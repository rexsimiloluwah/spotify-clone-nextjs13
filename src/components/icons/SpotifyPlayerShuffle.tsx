...
interface SpotifyPlayerShuffleProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

const SpotifyPlayerShuffle: React.FC<SpotifyPlayerShuffleProps> = ({
  size,
  ...props
}) => {
  return (
...
SpotifyPlayerShuffle.defaultProps = {
  size: 24,
};

export default SpotifyPlayerShuffle;
